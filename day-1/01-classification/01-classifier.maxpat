...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.800008177757263, 226.400003373622894, 29.5, 22.0 ],
					"text" : "$1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 548.800008177757263, 259.200003862380981, 36.0, 22.0 ],
					"text" : "> -40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 548.800008177757263, 193.750000178813934, 89.0, 22.0 ],
					"text" : "fluid.loudness~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 277.300005495548248, 244.400004923343658, 242.0, 110.0 ],
					"setminmax" : [ -40.0, 40.0 ],
					"size" : 13
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.400000154972076, 226.400003373622894, 36.0, 22.0 ],
					"text" : "defer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.200006246566772, 598.400008916854858, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.400005578994751, 598.400008916854858, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.400006592273712, 453.600006759166718, 35.0, 22.0 ],
					"text" : "oboe"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.800005495548248, 453.600006759166718, 59.0, 22.0 ],
					"text" : "trombone"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.600004374980927, 516.000007688999176, 53.0, 22.0 ],
					"text" : "pack s s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 140.800002098083496, 438.400006532669067, 179.0, 22.0 ],
					"text" : "combine analysis- s @triggers 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 140.800002098083496, 389.600005805492401, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.50000274181366, 358.400005280971527, 63.599998712539673, 20.0 ],
					"text" : " add point"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 140.800002098083496, 356.400005280971527, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.600004374980927, 560.000008344650269, 87.0, 22.0 ],
					"text" : "addlabel $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.800002098083496, 560.000008344650269, 123.0, 22.0 ],
					"text" : "addpoint $1 mfccsbuf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "buffer" ],
					"patching_rect" : [ 53.400000154972076, 259.200003862380981, 197.0, 22.0 ],
					"text" : "fluid.list2buf @destination mfccsbuf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 293.600004374980927, 640.800009548664093, 148.0, 22.0 ],
					"text" : "fluid.labelset~ instruments"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 140.800002098083496, 640.800009548664093, 131.0, 22.0 ],
					"text" : "fluid.dataset~ analyses"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 53.400000154972076, 193.750000178813934, 158.0, 22.0 ],
